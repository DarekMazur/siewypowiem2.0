...
const PrivacyView = () => {
  return (
    <MainWrapper>
      ...
      <ol>
        <li>
          privacy.content.generalInformation.header
          <ol>
            <li>
              Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod
              adresem url: siewypowiem.pl
            </li>
            <li>
        ...
        <li>
          ...
          <ol>
            <li>
              ...
              firma hostingowa na zasadzie powierzenia o upoważnieni pracownicy
        ...
        <li>
          ...
          <ol>
            <li>
              ...
              wynikające z plików cookies przy pomocy{' '}
              <StyledLink
